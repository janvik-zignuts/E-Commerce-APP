		...
		>
            ...
            `}
					...
					<div className="flex items-center space-x-4">
						...
						<div className="p-6 border-t border-border flex justify-end cursor-pointer">
							<button
								onClick={handleLogout}
								disabled={logoutLoading}
								className="flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition disabled:opacity-50 cursor-pointer"
							>
								{logoutLoading && (
